...
(function() {
    ...
    panel.style = "position:fixed;top:70px;left:5px;z-index:10001;background:#1a1a1a;padding:15px;border:2px solid #00ff00;border-radius:12px;color:#00ff00;width:240px;font-family:monospace;box-shadow:0 0 20px #00ff0044;";

    panel.innerHTML = `

        <b style="font-size:14px;color:#fff;">HAKO_EPUB <span style="color:#00ff00;">FIX v9.4</span></b>
        ...
        <button id="btn-start" style="background:#00ff00;color:#000;width:100%;border:none;padding:10px;font-weight:bold;border-radius:6px;">BẮT ĐẦU CÀO</button>

        <button id="btn-resume" style="display:none;background:#444;color:#fff;width:100%;border:none;padding:8px;font-size:11px;border-radius:6px;margin-top:5px;">TIẾP TỤC</button>
    ...
    async function run(isResume) {
        ...
        for (let i = startIdx; i < links.length; i++) {
            ...
            const chapter = await new Promise((resolve) => {
                ...
                // Tăng lên 30 giây để tránh bỏ qua nhầm khi mạng chậm
